...
function AutoLayout(eventBus, elementRegistry, elementFactory, modeling, alignElements) {
...
AutoLayout.$inject = [ 'eventBus', 'elementRegistry', 'elementFactory', 'modeling', 'alignElements' ];
